...
export interface ConfigurationParameters {
  ...
  Dragonfruitname?: string; // parameter for basic security
...
export class Configuration {
  ...
  get Dragonfruitname(): string | undefined {
    return this.configuration.Dragonfruitname;
  }
...
export function CherryConsumeForm(consumes: Consume[]): boolean {
